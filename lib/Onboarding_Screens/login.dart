...
class LoginScreen extends ConsumerWidget {
  ...
  //   ref.read(authProvider.notifier).loginUser('Benny', "PasswordTest");
                              ...
                              children: [
                                ...
                                RoundedElevatedButton(() async {
                                  await ref
                                    ...
                                    context.beamBack();
                                  Beamer.of(context).update();
                                }, "Log In", Constants.lightThemePrimaryColor,
                                    Colors.black, 45),
                              ],
                            ),
                          ),
                          Container(
                            ...
                            child: TextButton(
                              ...
                              child: Text("Forgot Password?",
                                  style:
                                      Constants.lightThemeTextButtonTextStyle),
                            ),
                          ),
                        ],
                      ),
                        ...
                        children: [
                              ...
                              children: [
                                ...
                                RoundedElevatedButton(() async {
                                  await ref
                                     ...
                                     context.beamBack();
                                  Beamer.of(context).update();
                                }, "Log In", Constants.darkThemePrimaryColor,
                                    Colors.black, 45),
                              ],
                            ),
                          ),
                          Container(
                            ...
                            child: TextButton(
                              ...
                              child: Text("Forgot Password?",
                                  style:
                                      Constants.darkThemeTextButtonTextStyle),
                            ),
                          ),
                        ],
                      ),
