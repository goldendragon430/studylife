  ...
  Widget build(BuildContext context) {
    return Consumer(
      builder: (_, WidgetRef ref, __) {
        ...
        double percentageProgress = (widget.taskItem.progress ?? 0 / 10) * 100;
          ...
          child: Stack(
            children: [
              Container(
                ...
                child: Image.network(
                  widget.taskItem.subject?.imageUrl ?? "",
                  fit: BoxFit.fill,
                  height: 206,
                  width: double.infinity,
                ),
              ...
              TaskDetailsInfoCard(widget.taskItem),
              Padding(
                        ...
                        Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: LinearProgressBar(
                              ...
                              currentStep: widget.taskItem.progress ?? 0,
                              //currentStep: 7,
