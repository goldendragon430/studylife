...
final List<CalendarEventData<Event>> _events = [
  ...
  CalendarEventData(
    date: _now.add(Duration(days: 1)),
    startTime: DateTime(_now.add(Duration(days: 1)).year,
        _now.add(Duration(days: 1)).month, _now.add(Duration(days: 1)).day, 10),
    endTime: DateTime(_now.add(Duration(days: 1)).year,
        _now.add(Duration(days: 1)).month, _now.add(Duration(days: 1)).day, 12),
